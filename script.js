const bannerText = "< Conoce Ad Astra"; // Texto 
const finalText = "<span class='symbols'>&lt;</span> Conoce <span class='italic'>Ad Astra</span> <span class='symbols'>&lt;/&gt;</span><span class='underscore'>_</span>"; // Texto final con guión bajo y símbolos coloreados
const randomChars = "abcdefghijklmnÑopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789¡?#/><%&(!)_-[]+=";
const display = document.getElementById('banner-text');
let index = 0;
let interval;

// Colores aleatorios
const colors = ['#6c5ae6ff', '#6c5ae6ff'];
